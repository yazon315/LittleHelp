...
## Порядок записи и выполнения операторов SQL-запроса
...
## Типы данных и изменение типов данных
...
Временные таблицы (общие табличные выражения) используют для того, чтобы упорядочить и систематизировать код с подзапросами. Они помогают структурировать подзапросы и вынести их за пределы основного запроса.  
...
### Операторы `JOIN` (горизонтальное объединение)
...
### Операторы `UNION` (вертикальное объединение)
...
### Функции в составе оконных функций:
- Ранжирования:
...
### Просмотр таблиц и типов данных в них
